...
# camera/UI requests
signal move_camera_to_selection_requested(selection_item, viewpoint, rotation, instant_move)
signal move_camera_to_body_requested(body, viewpoint, rotation, instant_move)
